...
import { getProducerById } from 'apiSdk/producers';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('producer', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/producers/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('product', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/products/create?producer_id=${data?.id}`}>
