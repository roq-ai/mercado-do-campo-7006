...
function ProductListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<ProductInterface[]>(
    ...
    () =>
      getProducts({
        relations: ['producer', 'review.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  <Th>price</Th>
                  <Th>category</Th>
                  {hasAccess('producer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>producer</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('producer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/producers/view/${record.producer?.id}`}>
